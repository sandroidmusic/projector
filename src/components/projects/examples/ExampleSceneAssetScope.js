 ...
 */
export default class ExampleSceneAssetScope extends AbstractScene {
  //---------------------------------------------------
  //
  //  Constructor
  //
  ...
  play() {
    ...
    this.tween.fromTo(this.group.scale, { x: 150, y: 150 }, { x: 50, y: 50, duration: MidiController.barLength * 4, yoyo: true, repeat: -1 });
  }
  ...
  async setup() {
    ...
    const gridX = 7;
    const gridY = 7;
    this.material = await ThreeMaterial.load.image('/assets/examples/outrun-sun.jpg');
